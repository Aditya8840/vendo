...
const DEFAULT_MODELS: Record<string, ProviderSpec> = {
  ...
  openai: {
    ...
    // Floored at 3.0.35: under `store: false` reasoning travels as
    // `reasoning.encrypted_content`, which older 3.x providers do not send.
    install: "npm install ai@^6 @ai-sdk/openai@^3.0.35",
